...
# ========== Banner ==========
def print_banner():
    eternal_ascii = pyfiglet.figlet_format("ETERNAL")
    print(colored(eternal_ascii, "green"))
    print(colored("Author : ETERNAL", "yellow"))
    print(colored("Ethical Phone Information Lookup Tool v1.0", "cyan"))
    print("="*70)
